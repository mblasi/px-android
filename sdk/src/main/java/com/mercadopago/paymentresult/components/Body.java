...
public class Body extends Component<PaymentResultBodyProps> {
    ...
    public boolean hasTopCustomComponent() {
        return hasPaymentResultScreenPreference() && CheckoutStore.getInstance().getPaymentResultScreenPreference().getApprovedTopCustomComponent() != null;
    }

    public boolean hasBottomCustomComponent() {
        return hasPaymentResultScreenPreference() && CheckoutStore.getInstance().getPaymentResultScreenPreference().getApprovedBottomCustomComponent() != null;
    }
